...
class ActionQueueManager {
    ...
    /**
     * Processes actions from the queue one by one, ensuring sequential execution.
     * This method is async-safe and will handle both synchronous and asynchronous actions.
     */
        ...
        while (this.queue.length > 0) {
            ...
            if (item) {
                try {
                    ...
                    console.error('[ActionQueue] Error processing action:', error);
                }
            }
        }
     ...
     * Useful for emergency recovery or cleanup scenarios.
     */
    public clear(): void {
        this.queue = [];
    }
...
/**
 * Singleton instance of ActionQueueManager for global access.
 */
